...
function buildItems(pool: (string | DomeImage)[], seg: number): GridItem[] {
  ...
  // Dynamically fill slots by repeating images
  const usedImages: DomeImage[] = [];
  for (let i = 0; i < totalSlots; i++) {
    usedImages.push(normalizedImages[i % normalizedImages.length]);
  }

  // Shuffle pseudo-randomly to avoid visible repeating patterns when pool size < totalSlots
  ...
  // Clean adjacent duplicates if possible
